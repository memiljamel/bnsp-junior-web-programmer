...
$blogs = read("SELECT * FROM tbl_blog ORDER BY id DESC");
          ...
          <div class="col-md-3 d-flex ftco-animate">
              ...
              <div class="text">
                ...
                <div class="meta mb-3">
                  ...
                  <div><a href="#"><?= $blog["owner"]; ?></a></div>
                  <div><a href="#" class="meta-chat"><span class="icon-chat"></span> 3</a></div>
                </div>
                <a href="blog-single.php" class="block-20 img" style="background-image: url('images/<?= $blog["picture"]; ?>');">
	              </a>
