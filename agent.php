...
$agents = read("SELECT * FROM tbl_agent ORDER BY id DESC");
			...
			<div class="col-md-3">
        		<div class="agent">
					...
					<div class="desc">
						...
						<p class="h-info"><span class="position">Listing</span> <span class="details">&mdash; <?= $agent["count_property"]; ?> Properties</span></p>
					</div>
				</div>
        	</div>
