...
$propertys = read("SELECT * FROM tbl_property ORDER BY id DESC LIMIT 3");
$testimonials = read("SELECT * FROM tbl_testimonial ORDER BY id DESC");
$agents = read("SELECT * FROM tbl_agent ORDER BY id DESC LIMIT 4");

if (isset($_POST["search"])) {
  $propertys = search($_POST["keyword"]);
}
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="testimonial.php" class="nav-link">Testimonials</a></li>
        ...
        <div class="row no-gutters slider-text justify-content-center align-items-center">
          <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
          	<div class="text text-center">
	            ...
	            <form action="" method="post" class="search-location mt-md-5">
		        		<div class="row justify-content-center">
		        			<div class="col-lg-10 align-items-end">
		        				<div class="form-group">
		          				<div class="form-field">
				                <input type="text" name="keyword" class="form-control" placeholder="Search location">
				                <button type="submit" name="search"><span class="ion-ios-search"></span></button>
				              </div>
			              </div>
		        			</div>
		        		</div>
    ...
    <section class="ftco-section goto-here">
        ...
        <div class="col-md-4">
          <div class="property-wrap ftco-animate">
            <a href="#" class="img" style="background-image: url(images/<?= $property["picture"]; ?>);"></a>
            <div class="text">
              <p class="price"><span class="old-price">Rp. 80000</span><span class="orig-price"><?= $property["price"]; ?><small>/mo</small></span></p>
              ...
              <span class="location"><?= $property["place"]; ?></span>
                ...
                <div class="testimony-wrap py-4">
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(files/<?= $testimonial["avatar"]; ?>)"></div>
                    	<div class="pl-3">
		                    <p class="name"><?= $testimonial["name"]; ?></p>
		                    <span class="position"><?= $testimonial["job"]; ?></span>
                        <div>
                          <a href="update.php?id=<?= $testimonial['id'] ?>">Update</a> |
                          <a href="delete.php?id=<?= $testimonial["id"] ?>">Delete</a>
                        </div>
		                  </div>
	                  </div>
                  </div>
    ...
    <section class="ftco-section ftco-agent ftco-no-pt">
        ...
        <?php foreach($agents as $agent) : ?>
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="agent">
    					<div class="img">
		    				<img src="images/<?= $agent["avatar"]; ?>" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="desc">
	    					<h3><a href="properties.php"><?= $agent["name"]; ?></a></h3>
								<p class="h-info"><span class="location">Listing</span> <span class="details">&mdash; <?= $agent["count_property"]; ?> Properties</span></p>
	    				</div>
    				</div>
        	</div>
